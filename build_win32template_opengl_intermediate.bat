...
IF !FOUND_PATH!==0 (
	...
	set CL_OPTIONS=/nologo /Od /TP /Fek15_win32template_opengl_intermediate.exe /MTd /TP /W3 /WX /Od /Gm- /Z7 /link /PDB:k15_win32template_opengl_intermediate.pdb
	set BUILD_COMMAND=!CL_PATH! k15_win32template_opengl_intermediate.c !CL_OPTIONS!
	call !VCVARS_PATH!
	call !BUILD_COMMAND!
) 